        ...
        <ul class="nav navbar-nav">
            ...
            <security:authorize access="not isAuthenticated()">
                <li class="headerButton">
                    ...
                    <a href="https://loginza.ru/api/widget?token_url=${pageContext.request.scheme}://${pageContext.request.serverName}${pageContext.request.contextPath}:${pageContext.request.serverPort}/login/openid"
